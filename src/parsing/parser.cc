...
#line 65 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:397


// First part of user declarations.

#line 70 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:404
...
#line 84 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:412
...
namespace  Ni  {
#line 151 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:479
...
#line 674 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 8:
#line 167 "parser.y" // lalr1.cc:859
    {yylhs.value.as< AST::DeclarationNode* > () = new AST::DeclarationNode(yystack_[4].value.as< AST::Types > (), yystack_[3].value.as< std::string > (), yystack_[1].value.as< AST::ASTNode* > ()); std::cout << yystack_[1].value.as< AST::ASTNode* > () << std::endl;}
#line 680 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 9:
#line 171 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::Types > () = AST::StringToType(yystack_[0].value.as< std::string > ()); }
#line 686 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;
...
#line 692 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;
...
#line 698 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 12:
#line 180 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = nullptr; }
#line 704 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 13:
#line 181 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = nullptr; }
#line 710 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 15:
#line 189 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::BlockNode* > () = yystack_[0].value.as< AST::BlockNode* > (); }
#line 716 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 16:
#line 193 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::BlockNode* > () = new AST::BlockNode(yystack_[0].value.as< AST::ASTNode* > ()); }
#line 722 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;
...
#line 770 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 25:
#line 215 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = new AST::BinOpNode("-", yystack_[2].value.as< AST::ASTNode* > (), yystack_[0].value.as< AST::ASTNode* > ()); }
#line 776 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 26:
#line 216 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[0].value.as< AST::ASTNode* > (); }
#line 782 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 27:
#line 217 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[0].value.as< AST::ASTNode* > (); }
#line 788 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 28:
#line 221 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = new AST::BinOpNode("*", yystack_[2].value.as< AST::ASTNode* > (), yystack_[0].value.as< AST::ASTNode* > ()); }
#line 794 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 29:
#line 222 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = new AST::BinOpNode("/", yystack_[2].value.as< AST::ASTNode* > (), yystack_[0].value.as< AST::ASTNode* > ()); }
#line 800 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 30:
#line 223 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[0].value.as< AST::ASTNode* > (); }
#line 806 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 31:
#line 228 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[1].value.as< AST::ASTNode* > (); }
#line 812 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 32:
#line 229 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[0].value.as< AST::ASTNode* > (); }
#line 818 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 33:
#line 230 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = yystack_[0].value.as< AST::ASTNode* > (); }
#line 824 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;
...
#line 830 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 35:
#line 235 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = new AST::DoubleNode(yystack_[0].value.as< double > ()); }
#line 836 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;
...
#line 846 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;

  case 37:
#line 247 "parser.y" // lalr1.cc:859
    { yylhs.value.as< AST::ASTNode* > () = new AST::BoolNode(yystack_[0].value.as< bool > ()); }
#line 852 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
    break;


#line 856 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  const signed char
   Parser ::yypact_[] =
  {
       0,   -41,   -15,    40,   -41,    46,    -2,   -41,   -41,    11,
     -41,    12,   -15,   -41,   -41,    16,    34,    13,     7,   -15,
      41,     7,   -11,   -41,   -41,   -41,   -41,    -5,    14,   -41,
     -41,   -41,    15,    42,   -41,   -15,     2,   -41,   -41,   -11,
     -11,   -11,   -11,   -41,    43,    45,   -41,    14,    14,   -41,
     -41,     1,   -41,    43,    -8,   -41,   -41,     3,   -41,   -41,
     -41,   -41,    48,    -4,   -41,   -41,   -41
  };
  ...
  const signed char
   Parser ::yypgoto_[] =
  {
     -41,   -41,   -41,    58,   -40,     6,   -41,    33,   -41,    18,
     -41,    19,   -41,   -41,   -19,    17,   -12,   -41,   -41
  };
  ...
  const unsigned char
   Parser ::yytable_[] =
  {
       1,     2,    36,     2,     3,    54,     3,    54,    11,    21,
      37,    56,    21,    22,    38,    66,    22,    56,    17,    39,
      39,    40,    40,    46,    55,    32,    39,    21,    40,    49,
      50,    22,     4,    23,    24,    63,    23,    24,    25,    61,
      26,    32,    41,    12,    42,     4,    13,     4,     4,    18,
       4,    23,    24,    25,    19,    26,    47,    48,    15,    16,
      20,    35,    43,    44,    14,    51,    53,    65,    45,     0,
       0,    60,     0,     0,     0,     0,    64
  };
  ...
  const signed char
   Parser ::yycheck_[] =
  {
       0,     3,    21,     3,     6,     4,     6,     4,     2,    20,
      22,    51,    20,    24,    19,    19,    24,    57,    12,    24,
      24,    26,    26,    21,    23,    19,    24,    20,    26,    41,
      42,    24,    47,    44,    45,    54,    44,    45,    46,    47,
      48,    35,    28,     3,    30,    47,     0,    47,    47,    33,
      47,    44,    45,    46,    20,    48,    39,    40,    47,    47,
      47,    20,    47,    21,     6,    22,    21,    19,    35,    -1,
      -1,    53,    -1,    -1,    -1,    -1,    57
  };
   ...
   Parser ::yyrline_[] =
  {
     ...
     175,   176,   180,   181,   185,   189,   193,   194,   195,   199,
     200,   204,   205,   209,   214,   215,   216,   217,   221,   222,
     223,   228,   229,   230,   234,   235,   241,   247
  };
...
#line 1264 "C:/Users/tomjp/Desktop/nilang/src/parsing/parser.cc" // lalr1.cc:1167
#line 249 "parser.y" // lalr1.cc:1168
